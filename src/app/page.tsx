  ...
  return (
    <main>
      ...
      <div className="Circle-Background">
        <Image src={CirBack} alt="Circle Background" width={305}
            height={361}/>
      </div>
      <div className="Text-Container">
        ...
        <p>
          ...
          <Link href="https://digitalcareerinstitute.org/">
            Digital Career Institute gGmbH (DCI)
          </Link>
        ...
        <p>
          Fals du mich für kleine Projekte Buchen möchtest, schreibe mir gerne
          per WahtsApp.
        </p>
