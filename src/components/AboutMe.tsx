...
const AboutMe = () => {
  ...
  return (
    <div className="section" id="aboutMe">
      ...
      <p className="text">
        Hallo, mein Name ist Danny, ich bin 32 Jahre alt und stamme aus der
        wunderschönen Stadt Hamburg. Mein beruflicher Werdegang war eine
        spannende Reise, auf der ich verschiedene Pfade erkundet habe, um
        herauszufinden, wo meine Leidenschaft und mein Talent wirklich liegen.
        Nachdem ich meine Ausbildung als Kfz-Mechatroniker begonnen hatte,
        sammelte ich über sechs Jahre lang wertvolle Erfahrungen in drei
      ...
      <p className="text">
        Auf meiner beruflichen Entdeckungsreise habe ich auch andere Wege
      ...
      <p className="text">
        Im Jahr 2020 bot sich mir dann die aufregende Möglichkeit, bei Rafi
      ...
      <p className="text">
        Im Jahr 2021 gründete ich Moin Moin Möbelmonteur und begann, eine
        Vielzahl von Kunden zu betreuen. Alles lief gut, bis die
        COVID-19-Pandemie zuschlug und die wirtschaftliche Landschaft
        ...
        DCI zum Web- und Softwareentwickler.
      </p>
      <p className="text">
      ...
      <p className="text">
        Im Jahr 2022 begann ich ein Praktikum bei SugarShape, einem
      ...
      <p className="text">
        Im Jahr 2024 starteten wir bei SugarShape mit dem Umzug unseres
        Oxid-Shops zu Shopify, was eine aufregende neue Phase in meiner Karriere
        als Entwickler darstellte.
      </p>
      <p className="text">
        Neben meiner Tätigkeit bei SugarShape investiere ich auch Zeit und
        Energie in private Projekte, mit denen ich mein Portfolio erweitern und
        mir langfristig ein zusätzliches Einkommen erhoffe. Bislang habe ich
        bereits vier vielversprechende Projekte in der Pipeline.
      </p>
      <p className="text">
        Diese privaten Projekte bieten mir nicht nur die Möglichkeit, mein
        Fachwissen und meine Fähigkeiten weiterzuentwickeln, sondern auch, meine
        kreative Seite auszuleben und neue Technologien zu erkunden. Jedes
        Projekt birgt seine eigenen Herausforderungen und Chancen, und ich bin
        bestrebt, sie alle erfolgreich umzusetzen.
      </p>
      <p className="text">
        Die Vielfalt meiner Projekte spiegelt meine breite Interessenpalette
        wider und ermöglicht es mir, mich in verschiedenen Bereichen der
        Softwareentwicklung zu engagieren. Von der Entwicklung innovativer Apps
        bis hin zur Gestaltung benutzerfreundlicher Websites - ich bin stets
        bestrebt, meine Fähigkeiten zu erweitern und neue Wege zu finden, um
        Mehrwert zu schaffen.
      </p>
      <p className="text">
        Durch meine privaten Projekte kann ich meine Kreativität und
        Innovationskraft voll entfalten und gleichzeitig mein unternehmerisches
        Denken schärfen. Mein Ziel ist es, diese Projekte langfristig
        erfolgreich zu etablieren und mein eigenes Unternehmen aufzubauen, das
        auf meinen individuellen Fähigkeiten und Leidenschaften basiert.
      </p>
    </div>
  );
};
