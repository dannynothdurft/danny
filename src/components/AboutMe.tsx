...
const AboutMe = () => {
  ...
  return (
    <div className="section" id="aboutMe">
      ...
      <p className="text">
        Die Vielfalt meiner <b>Projekte</b>
      ...
      <p className="text">
        Durch meine <b>privaten Projekte</b>
